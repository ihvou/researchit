...
import { ensureDimensionArgumentShape, applyThreadArgumentUpdates } from "./arguments.js";
import { getResearchBriefForLowConfidence } from "./researchBrief.js";
...
export function getDimensionView(uc, dimId, options = {}) {
  ...
  const dimLabel = options?.dimLabel || dim?.label || "";
