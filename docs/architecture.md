...
- Stage `03c` requires all configured Deep Research providers (OpenAI o3-deep-research + Anthropic claude-sonnet-4-6 web-research lane + Gemini deep-research-pro-preview-12-2025) and fails preflight if any required lane is missing.
