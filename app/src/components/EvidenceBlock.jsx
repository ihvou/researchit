  ...
  while (match) {
    ...
    parts.push(
      <a
        ...
        style={{ color: "var(--ck-blue)", textDecoration: "none", fontWeight: 600 }}>
        Source {sourceIdx}
      </a>
    );
      ...
      {(full || sources?.length || risks) && (
        <>
          <button
            ...
            style={{ background: "none", border: "none", color: "var(--ck-blue)", fontSize: 11, padding: 0, cursor: "pointer", marginBottom: expanded ? 10 : 0 }}>
            ...
            <div style={{ marginTop: 10, paddingTop: 10, borderTop: "1px solid var(--ck-line)" }}>
              ...
              {risks && (
                <div style={{
                  ...
                  background: "var(--ck-risk-bg)", borderLeft: "3px solid var(--ck-risk-line)",
                  borderRadius: "0 6px 6px 0",
                }}>
                  <div style={{ fontSize: 10, color: "#b54708", fontWeight: 700, marginBottom: 3, textTransform: "uppercase", letterSpacing: 0.8 }}>
                    Key Risks & Caveats
                  </div>
                  <p style={{ fontSize: 11, color: "#93370d", margin: 0, lineHeight: 1.6 }}>{risks}</p>
                </div>
              )}
            </div>
          )}
