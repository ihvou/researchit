          ...
          <div style={{ display: "grid", gap: 8, marginBottom: 10 }}>
            ...
            <div style={{ fontSize: 11, color: "var(--ck-muted)", lineHeight: 1.5 }}>
              {evidenceMode === "deep-research-x3"
                ? <><strong style={{ color: "var(--ck-text)" }}>ChatGPT</strong> Deep Research, <strong style={{ color: "var(--ck-text)" }}>Gemini</strong> Deep Research, and a high-depth <strong style={{ color: "var(--ck-text)" }}>Claude</strong> web-research lane run in parallel for maximum evidence depth. Findings are merged, then <strong style={{ color: "var(--ck-text)" }}>Claude</strong> applies independent critic review, <strong style={{ color: "var(--ck-text)" }}>ChatGPT</strong> defends or concedes each flag, and <strong style={{ color: "var(--ck-text)" }}>Gemini</strong> writes the final synthesis.</>
